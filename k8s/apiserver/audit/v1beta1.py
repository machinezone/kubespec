...
class ObjectReference(types.Object):
    ...
    def subresource(self) -> Optional[str]:
        ...
        if 'subresource' in self._context and check_return_type(self._context['subresource']):
...
class Event(base.TypedObject):
    ...
    def requestURI(self) -> str:
        ...
        if 'requestURI' in self._context and check_return_type(self._context['requestURI']):
    ...
    def impersonatedUser(self) -> Optional['authenticationv1.UserInfo']:
        ...
        if 'impersonatedUser' in self._context and check_return_type(self._context['impersonatedUser']):
    ...
    def sourceIPs(self) -> List[str]:
        ...
        if 'sourceIPs' in self._context and check_return_type(self._context['sourceIPs']):
    ...
    def userAgent(self) -> Optional[str]:
        ...
        if 'userAgent' in self._context and check_return_type(self._context['userAgent']):
    ...
    def objectRef(self) -> Optional[ObjectReference]:
        ...
        if 'objectRef' in self._context and check_return_type(self._context['objectRef']):
    ...
    def responseStatus(self) -> Optional['metav1.Status']:
        ...
        if 'responseStatus' in self._context and check_return_type(self._context['responseStatus']):
    ...
    def requestObject(self) -> Optional['runtime.Unknown']:
        ...
        if 'requestObject' in self._context and check_return_type(self._context['requestObject']):
    ...
    def responseObject(self) -> Optional['runtime.Unknown']:
        ...
        if 'responseObject' in self._context and check_return_type(self._context['responseObject']):
    ...
    def requestReceivedTimestamp(self) -> 'base.MicroTime':
        ...
        if 'requestReceivedTimestamp' in self._context and check_return_type(self._context['requestReceivedTimestamp']):
    ...
    def stageTimestamp(self) -> 'base.MicroTime':
        ...
        if 'stageTimestamp' in self._context and check_return_type(self._context['stageTimestamp']):
...
class PolicyRule(types.Object):
    ...
    def userGroups(self) -> List[str]:
        ...
        if 'userGroups' in self._context and check_return_type(self._context['userGroups']):
    ...
    def omitStages(self) -> List[Stage]:
        ...
        if 'omitStages' in self._context and check_return_type(self._context['omitStages']):
