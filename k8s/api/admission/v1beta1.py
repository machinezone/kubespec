...
class AdmissionRequest(types.Object):
    ...
    def requestKind(self) -> Optional['metav1.GroupVersionKind']:
        ...
        if 'requestKind' in self._context and check_return_type(self._context['requestKind']):
    ...
    def requestResource(self) -> Optional['metav1.GroupVersionResource']:
        ...
        if 'requestResource' in self._context and check_return_type(self._context['requestResource']):
    ...
    def requestSubResource(self) -> Optional[str]:
        ...
        if 'requestSubResource' in self._context and check_return_type(self._context['requestSubResource']):
    ...
    def operation(self) -> Operation:
        ...
        if 'operation' in self._context and check_return_type(self._context['operation']):
    ...
    def oldObject(self) -> 'runtime.RawExtension':
        ...
        if 'oldObject' in self._context and check_return_type(self._context['oldObject']):
...
class AdmissionResponse(types.Object):
    ...
    def patchType(self) -> Optional[PatchType]:
        ...
        if 'patchType' in self._context and check_return_type(self._context['patchType']):
    ...
    def auditAnnotations(self) -> Dict[str, str]:
        ...
        if 'auditAnnotations' in self._context and check_return_type(self._context['auditAnnotations']):
